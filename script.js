...
function backgroundGif(weather_icon) {
    let icon = weather_icon;
    console.log("BackgroungGif Funktion" + " weather-icon " + weather_icon + "  " + icon);
    document.getElementById("bg-image").style.backgroundImage = "url(bg\\\\"+icon+".jpg)";
}